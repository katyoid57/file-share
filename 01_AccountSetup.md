...
1. ご案内した**研修資料の URL** をブラウザで開き、その中の **資料ダウンロード**のページから資料をすべてダウンロードする（URL が開かない場合は APD GrowthTech推進部へ連絡してください）

2. ダウンロードしたファイルの中に ZIP ファイルがあれば、右クリック → **すべて展開** → **展開** で展開する
