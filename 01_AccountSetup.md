...
6/8（月）に招待メールをお送りします。以下の手順でセットアップしてください。
...
> **上流工程研修について:** Claude Code（CLI）に加え、ブラウザの claude.ai チャット画面も使用します。①で作成したアカウントでそのままログインしてご利用ください。
...
1. メールで共有された URL にブラウザでアクセスし、パスワードを入力して資料をすべてダウンロードする

2. ダウンロードしたファイルの中に ZIP ファイルがあれば、右クリック → **その他のオプションを確認** → **7-Zip** → **ここに展開** で展開する
