...
> **上流工程研修の方へ:** 上流工程研修では Claude デスクトップアプリの Code タブを使います。この先の手順は下流工程研修・AI駆動開発研修向けの内容なので、[05_UpstreamAccountSetup.md](05_UpstreamAccountSetup.md) を参照してください。
...
### 5. Office Viewer のインストール（上流工程研修のみ）
